...
export default function CoordinatorLoginPage() {
  ...
  return (
    ...
    >
      <div className="bg-zinc-950/68 absolute inset-0 backdrop-blur-[2px]" />
      <div className="absolute inset-0 bg-gradient-to-br from-red-950/55 via-zinc-950/55 to-black/85" />
      <div className="absolute inset-x-0 bottom-0 h-48 bg-gradient-to-t from-black/70 to-transparent" />

      <div className="relative z-10 w-full max-w-md">
        <div className="bg-white/12 rounded-lg border border-white/20 p-6 shadow-2xl shadow-black/45 backdrop-blur-xl transition-transform duration-300 sm:p-8 md:hover:-translate-y-0.5">
          <div className="text-center">
            <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-lg bg-red-700 text-white shadow-lg shadow-red-950/30 ring-1 ring-white/20">
              <ScrollText className="h-7 w-7" />
            </div>
            <p className="mt-4 text-sm font-semibold uppercase tracking-[0.2em] text-red-100">
              Internbot
            </p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-5">
            <div className="space-y-2">
              ...
              <input
                ...
                className="h-11 w-full rounded-md border border-white/20 bg-white/[0.92] px-3 text-sm text-zinc-950 shadow-sm outline-none transition placeholder:text-zinc-500 hover:bg-white focus:border-red-300 focus:ring-2 focus:ring-red-400/70"
