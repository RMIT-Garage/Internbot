...
Internbot is an internship platform for RMIT students and coordinators. The full workflow, API contract, status model, and Firestore domain rules live in [docs/WORKFLOW-API-SPEC.md](docs/WORKFLOW-API-SPEC.md).
...
- Workflow, API contract, statuses, and Firestore model:
  [docs/WORKFLOW-API-SPEC.md](docs/WORKFLOW-API-SPEC.md)
- Workflow API implementation roadmap (phased sprint contracts, one PR per phase):
  [docs/WORKFLOW-API-IMPLEMENTATION-PLAN.md](docs/WORKFLOW-API-IMPLEMENTATION-PLAN.md)
- System architecture:
...
- Handover and deployment (new Firebase account):
...
- Treat [docs/WORKFLOW-API-SPEC.md](docs/WORKFLOW-API-SPEC.md) as the domain source of truth.
